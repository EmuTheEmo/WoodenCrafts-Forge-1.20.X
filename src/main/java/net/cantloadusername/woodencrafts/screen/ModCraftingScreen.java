package net.cantloadusername.woodencrafts.screen;

import net.cantloadusername.woodencrafts.container.ModCraftingTableMenu;
...
public class ModCraftingScreen extends AbstractContainerScreen<ModCraftingTableMenu> implements RecipeUpdateListener {
    ...
    public ModCraftingScreen(ModCraftingTableMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
